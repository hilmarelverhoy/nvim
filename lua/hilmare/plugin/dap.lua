...
local env = {
DJANGO_KEY="Hilmar",
ELHUB_KEY_FILE="/elhub_key_file.key",
ELHUB_CERT_FILE="/elhub_cert_file.crt",
...
VIPPS_MSN="",
GLEDE_API_KEY="",
GLEDE_API_URL="https://sandbox.api.glede.app/v1/orders",
SLIPPER_INVOICE_EMAIL="hilmar.elverhoy@bouvet.no",
REDIS_URL="redis://redis:6379",
DJANGO_SETTINGS_MODULE = "slipper_api.settings",
DEBUG="True"
}
...
dap.configurations.python = {
  ...
  },
  {
    ...
    program = "docker",
    args = { "compose", "run", "--rm", "web", "python", "manage.py", "test", "${input:test_path}" },
    cwd = "${workspaceFolder}",
    console = "integratedTerminal",
    justMyCode = false,
    env=env,
